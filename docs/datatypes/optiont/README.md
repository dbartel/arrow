...
lifted
//(kotlin.Int) -> arrow.effects.ObservableKW<arrow.Option<arrow.Option<arrow.effects.ObservableKW<arrow.Option<arrow.Option<kotlin.String>>>>>>
```
...
optTVal
//OptionT(value=ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@515944e))
```
...
optTVal
//OptionT(value=ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@6896411c))
```
...
```kotlin
optTVal.value()
//ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@6896411c)
```
