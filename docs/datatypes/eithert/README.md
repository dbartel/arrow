...
lifted
//(kotlin.Int) -> arrow.effects.ObservableKW<arrow.Either<Line_2.BizError, arrow.Option<arrow.effects.ObservableKW<arrow.Either<Line_2.BizError, kotlin.String>>>>>
```
...
eitherTVal
//EitherT(value=ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@5fdf39ad))
```
...
```kotlin
eitherTVal.value()
//ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@5fdf39ad)
```
