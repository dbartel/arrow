...
//arrow.OptionMonadErrorInstanceImplicits$instance$1@a753053
```

```kotlin
monadError<TryHK, Throwable>()
//arrow.TryMonadErrorInstanceImplicits$instance$1@79b60207
```

```kotlin
monadError<EitherKindPartial<NukeException>, NukeException>()
//arrow.EitherMonadErrorInstanceImplicits$instance$1@1bf33527
```
